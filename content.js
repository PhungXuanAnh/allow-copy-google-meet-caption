...
// Function to run the caption copy script
function enableCaptionCopy() {
  ...
  if (targetNode) {
    ...
    const verifyStructure = () => {
      ...
      console.log(`📊 Google Meet Caption Copy: Found ${directChildren.length} direct children, ${captionContainers.length} caption containers`);
    ...
    console.log('🚀 Google Meet Caption Copy: Script Activated!');
    ...
    console.log('❌ Caption container not found. Captions may not be enabled yet.');
